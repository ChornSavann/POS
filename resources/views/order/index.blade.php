...
@section('content')
    <style>
        #categoryFilter {
            ...
            /* លាក់របារ Scroll សម្រាប់ Firefox */
        }

        #categoryFilter::-webkit-scrollbar {
            display: none;
            /* លាក់របារ Scroll សម្រាប់ Chrome/Safari */
        }
        ...
        <div class="row g-2 h-100">
            <div class="col-md-4 h-100">
                <div class="cart-container shadow-sm rounded bg-white border">
                        ...
                        <div class="row g-1">
                            ...
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" id="selected-table-name" class="form-control fw-bold text-primary"
                            ...
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    ...
                                    <select id="CustomersId" name="CustomerId"
                                        class="form-select border-primary shadow-none">
                    ...
                    <div class="cart-footer p-0 border-top bg-white">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-6 ps-2">
                                    ...
                                    <div class="d-flex justify-content-between mt-1">
                                        <span class="khmer">
                                            អាករលើតម្លៃបន្ថែម
                                            <a href="javascript:void(0)" onclick="openTaxModal()"
                                                class="text-primary ms-1"><i class="bi bi-pencil-square"></i></a>
                                        </span>
                        ...
                        <div class="grand-total-area px-3 py-2 d-flex justify-content-between align-items-center"
                            style="background-color: #dcedc8;">
                            <span class="khmer fw-bold fs-6">ប្រាក់ត្រូវបង់ <i
                                    class="bi bi-chat-dots-fill small"></i></span>
                            <h3 id="grandtotal" class="mb-0 fw-bold">$0.00</h3>
                        </div>

                        <div class="d-flex" style="height: 80px;">
                            <div class="d-flex flex-column" style="width: 30%;">
                                <button class="btn btn-warning rounded-0 border-white text-white flex-fill khmer py-1"
                                    id="btn-hold" style="background-color: #ff9800;">
                                    <i class="fa-solid fa-hand-pause me-1"></i> ពន្យារ
                                </button>
                                <button class="btn btn-danger rounded-0 border-white text-white flex-fill khmer py-1"
                                    id="clear-cart">
                            ...
                            <div class="d-flex flex-column" style="width: 30%;">
                                <button class="btn rounded-0 border-white text-white flex-fill khmer py-1" id="btn-order"
                                    style="background-color: #7e57c2;">
                                    <i class="fa-solid fa-utensils me-1"></i> កម្ម៉ង់
                                </button>
                                <button class="btn rounded-0 border-white text-white flex-fill khmer py-1" id="btn-print"
                            ...
                            <div class="flex-grow-1">
                                <button class="btn btn-success rounded-0 h-100 w-100 khmer fs-5 fw-bold"
                                    id="btn-pay-trigger" style="background-color: #2e7d32;">
            ...
            <div class="col-md-8 h-100">
                <div id="section-tables" class="animate-fade mt-2">
                    ...
                    <div
                        class="bg-white p-3 mb-3 shadow-sm rounded-3 d-flex justify-content-between align-items-center border-start border-primary border-4">
                        <h6 class="khmer mb-0 fw-bold"><i
                                class="bi bi-grid-3x3-gap-fill me-2 text-primary"></i>ជ្រើសរើសតុអាហារ</h6>
                        ...
                        @foreach ($tables as $table)
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-4 col-4">
                                <div class="table-card text-center p-3 select-table-btn {{ $isBusy ? 'busy' : '' }} bg-white shadow-sm rounded-3 cursor-pointer"
                                    ...
                                    <span
                                        class="badge border {{ $isBusy ? 'text-danger border-danger' : 'text-success border-success' }}"
                                        style="font-size: 9px;">
                ...
                <div id="section-products" class="d-none animate-fade mt-2">
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                        ...
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="productSearch" class="form-control rounded-pill px-3"
                                placeholder="ស្វែងរក...">
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        @foreach ($products as $p)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-4 product-item"
                                ...
                                <div class="card product-card border-0 shadow-sm h-100 cursor-pointer position-relative overflow-hidden product-name"
                                    ...
                                    <div class="card-body p-2 text-center border-top">
                                        <p class="khmer small mb-1 text-truncate fw-bold text-dark">{{ $p->name }}
                                        </p>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" id="cash-dollar" class="form-control text-end fw-bold"
                                        value="0">
                                </div>
                            </div>
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-6">
                                    ...
                                    <input type="number" id="discountRate" class="form-control form-control-sm text-end"
                                        readonly>
                                </div>
                                <div class="col-6">
                                    <label class="small fw-bold mb-1 text-danger">បញ្ចុះ ($)</label>
                                    <input type="text" id="discountAmount"
                                        class="form-control form-control-sm text-end text-danger" readonly>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text">៛</span>
                                    <input type="number" id="cash-riel" class="form-control text-end fw-bold"
                                        value="0">
                                </div>
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="row g-1">
                                @foreach ([1, 5, 10, 20, 50, 100] as $val)
                                    <div class="col-6">
                                        <button type="button" class="btn btn-outline-primary w-100 py-2 fw-bold small"
                                            onclick="addCash({{ $val }})">
                                            ${{ $val }}
                                        </button>
                                    </div>
                                ...
                                <div class="col-12 mt-1">
                                    <button type="button" class="btn btn-outline-danger w-100 py-1 small"
                                        onclick="clearCash()">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body p-4">
                    <div class="text-center mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="number" id="tax-rate-input"
                                ...
                                value="0" min="0" max="100" onfocus="this.select()">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-secondary w-100 fw-bold rounded-3"
                                onclick="setQuickTax(0)">0%</button>
                        </div>
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-secondary w-100 fw-bold rounded-3"
                                onclick="setQuickTax(5)">5%</button>
                        </div>
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-secondary w-100 fw-bold rounded-3"
                                onclick="setQuickTax(10)">10%</button>
                        </div>
                    </div>
                </div>

                <div class="modal-footer border-0 p-3 pt-0">
                    <button type="button" class="btn btn-light w-100 khmer py-2 rounded-3 text-muted"
                        data-bs-dismiss="modal">បោះបង់</button>
                    <button type="button" class="btn btn-primary w-100 khmer py-2 rounded-3 fw-bold"
                        onclick="saveTaxRate()">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btn-pay-trigger').click(function() {
                ...
                calculateFinalTotal();
                const modalInstance = bootstrap.Modal.getOrCreateInstance(document.getElementById(
                    'checkoutModal'));
                modalInstance.show();
            });
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function() {
                                Swal.fire('Error', 'មិនអាចទាក់ទងទៅកាន់ Server បានទេ',
                                    'error');
                            }
                        });
                    }
