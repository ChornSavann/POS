    ...
    <div class="container-fluid">
        <div class="header-card d-flex justify-content-between align-items-center flex-wrap gap-3 p-3 bg-white rounded shadow-sm"
            ...
            <div class="d-flex align-items-center">
                <div class="icon-wrapper me-3 bg-warning bg-opacity-10 p-3 rounded-circle" style="background-color: rgba(245, 158, 11, 0.1);">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    {{-- Avatar Placeholder --}}
                                    <div class="avatar-sm me-3 bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                            ...
                            <td>
                                <span class="badge rounded-pill {{ $user->role == 'admin' ? 'bg-primary-subtle text-primary' : 'bg-secondary-subtle text-secondary' }} px-3">
