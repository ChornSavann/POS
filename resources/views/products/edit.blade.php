...
<div class="container-fluid">
                            ...
                            <div class="col-xl-8 border-end">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-7">
                                        ...
                                        <input type="text" name="name" class="form-control form-control-lg border-success-subtle @error('name') is-invalid @enderror"
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="input-group shadow-sm">
                                            ...
                                            <button type="button" class="btn btn-success px-3 d-flex align-items-center" id="generate_barcode" title="បង្កើតកូដថ្មី">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="base_unit" name="unit_id" class="form-select bg-light border-success-subtle fw-bold">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="sale_unit" name="sale_unit_id" class="form-select border-success-subtle">
                                            <option value="{{ $product->sale_unit_id }}">{{ $product->saleUnit->name ?? '-- រង់ចាំខ្នាតគោល --' }}</option>
                                        </select>
                                    </div>

                                    <div class="col-md-4">
                                        <label class="form-label fw-bold small">ទិញចូល (Purchase Unit)</label>
                                        <select id="purchase_unit" name="purchase_unit_id" class="form-select border-success-subtle">
                                            <option value="{{ $product->purchase_unit_id }}">{{ $product->purchaseUnit->name ?? '-- រង់ចាំខ្នាតគោល --' }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="cost" class="form-control fw-bold border-success-subtle"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="price" class="form-control text-success fw-bold border-success"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        ...
                                        <input type="number" name="alert_qty" class="form-control border-success-subtle"
    ...
    <div class="p-3 border rounded bg-light">
        <div class="form-check form-switch">
            ...
            <input class="form-check-input" type="checkbox" name="status" value="1" id="statusSwitch" {{ $product->status ? 'checked' : '' }}>
            <label class="form-check-label fw-bold" for="statusSwitch" id="statusLabel">
                {{ $product->status ? 'បើកលក់ (Active)' : 'ផ្អាកលក់ (Inactive)' }}
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold small text-muted">រូបភាពទំនិញ (ទុកទទេបើមិនប្តូរ)</label>
                                    <div class="upload-zone text-center p-3 border-dashed rounded-4 bg-light position-relative">
                                        <img id="preview" src="{{ asset($product->image ? $product->image : 'assets/img/no-image.png') }}"
                                             class="img-fluid rounded mb-2" style="max-height: 200px; width: 100%; object-fit: contain;">
                    ...
                    <div class="card-footer bg-light p-4 rounded-bottom-4 border-top-0">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-success px-5 rounded-pill shadow-lg bg-gradient text-white">
...
<style>
    ...
    .bg-success.bg-gradient { background: linear-gradient(45deg, #198754, #146c43) !important; }
    .upload-zone:hover { background-color: #f1f3f5 !important; border-color: #198754 !important; }
    #generate_barcode:hover i { transform: rotate(180deg); transition: 0.4s ease-in-out; }
</style>
