                ...
                <div class="card-body py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 text-md-end">
                            ...
                            <button id="btnBulkDelete" class="btn btn-outline-danger px-3 me-2 shadow-sm"
                                style="display: none;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted"><i class="bi bi-upc"></i>
                                            {{ $product->barcode ?? 'N/A' }}</small>
                                    </td>
                                    <td>
                                        <span
                                            class="badge bg-info-subtle text-info border border-info-subtle rounded-pill small">
                                    ...
                                    <td class="text-center fw-bold text-success">${{ number_format($product->price, 2) }}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <span class="badge bg-secondary"><i class="bi bi-pause-circle"></i>
                                                ផ្អាក</span>
                                        @endif
                                    </td>
                                    <td class="text-end pe-3">
                                        <div class="btn-group shadow-sm">
                                            <button type="button" class="btn btn-sm btn-outline-info btn-view-product"
                                                data-name="{{ $product->name }}" data-barcode="{{ $product->barcode }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.sortable').click(function() {
                ...
                table.find('th i').removeClass('bi-arrow-up bi-arrow-down').addClass(
                    'bi-arrow-down-up opacity-50');
                if (this.asc) {
                    $(this).find('i').removeClass('bi-arrow-down-up opacity-50').addClass(
                        'bi-arrow-up opacity-100');
                } else {
                    $(this).find('i').removeClass('bi-arrow-down-up opacity-50').addClass(
                        'bi-arrow-down opacity-100');
                    rows = rows.reverse();
                }
            ...
            function comparer(index) {
                return function(a, b) {
                    ...
                    return valA.toString().localeCompare(valB, 'km', {
                        sensitivity: 'base'
                    });
                };
            }
