...
<style>
    ...
    body { background-color: var(--soft-bg); font-family: 'Inter', 'Kantumruy Pro', sans-serif; }
    ...
    #ordersTable thead { background-color: #f1f5f9; }
    ...
    .text-net-sales { color: #059669; font-weight: 700; }
...
<div class="container-fluid py-4 px-lg-4">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card-modern p-3 d-flex align-items-center border-primary shadow-sm" style="background: #f0f7ff;">
                <div class="icon-box bg-success text-white me-3">
                    <i class="bi bi-wallet2 fs-5"></i>
                </div>
                <div>
                    <small class="text-primary fw-bold text-uppercase" style="font-size: 0.7rem;">Net Sales (Today)</small>
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td class="text-center text-muted small">
                                <i class="bi bi-clock me-1"></i> {{ \Carbon\Carbon::parse($order->order_date)->format('H:i') }}
                            </td>
                            <td>
                                <span class="fw-medium text-dark">{{ $order->customer->name ?? 'Walk-in Customer' }}</span>
                            </td>
                            <td class="text-center">
                                <span class="badge badge-qty rounded-pill px-3">{{ $order->orderItems->sum('qty') }}</span>
                            </td>
                            ...
                            <td class="text-end pe-4 fw-bold text-net-sales">${{ number_format($order->grand_total, 2) }}</td>
